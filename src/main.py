if __name__ == "__main__":
    ...
    #speed = iss_speed.get_speed('photo1.jpg','photo2.jpg')
    ...
    while (now_time <= start_time + timedelta(minutes=9)):
        ...
        if (seconds % 30 == 0): # runs every 5 seconds
            cam.take_photo(image_folder / f"image{count}.jpg")
            pair.append(image_folder / f"image{count}.jpg")
            count += 1
